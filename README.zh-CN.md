...
[![版本](https://img.shields.io/badge/release-0.8.3-1A73E8)](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.3)
[![测试](https://img.shields.io/badge/tests-350%20passing-18a957)](#开发与验证)
...
| 插件 ID | `stitch-design` |
| 当前候选版本 | `0.8.3` |
| 当前版本 | [v0.8.3](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.3) |
| 上一版本 | [v0.8.2](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.2) |
...
功能问题请提交到 <https://github.com/full-stack-plugins/stitch-design-plugin/issues>。提交变更前，请说明你验证所用的 Stitch 接口范围、是否改动工具清单或写入结果规则，并附上受影响的校验器。
