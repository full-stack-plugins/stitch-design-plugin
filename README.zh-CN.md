...
[![版本](https://img.shields.io/badge/release-0.7.6-1A73E8)](https://github.com/partme-ai/codex-stitch-plugin/releases/tag/v0.7.6)
...
| 插件 ID | `stitch-design` |
| 当前候选版本 | `0.7.6` |
| 当前版本 | [v0.7.6](https://github.com/partme-ai/codex-stitch-plugin/releases/tag/v0.7.6) |
