...
[![版本](https://img.shields.io/badge/release-0.7.10-1A73E8)](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.7.10)
...
| 插件 ID | `stitch-design` |
| 当前候选版本 | `0.7.10` |
| 当前版本 | [v0.7.10](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.7.10) |
| 上一版本 | [v0.7.8](https://github.com/partme-ai/partme-stitch-plugin/releases/tag/v0.7.8) |
