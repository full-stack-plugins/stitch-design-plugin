...
class LiveCanaryTests(unittest.TestCase):
    def test_bilingual_docs_record_061_harness_and_repo_release_gates(self) -> None:
        ...
        self.assertIn("GitHub Release/repo Marketplace: v0.7.1 published", english)
        ...
        self.assertIn("GitHub Release/仓库 Marketplace：v0.7.1 已发布", chinese)
