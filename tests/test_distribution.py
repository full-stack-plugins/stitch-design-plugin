...
class DistributionContractTests(unittest.TestCase):
    def test_release_uses_074_across_active_surfaces(self) -> None:
        ...
        self.assertIn("compatibility distribution 0.7.4", validator.stdout)
    ...
    def test_architecture_documents_describe_secure_harness_boundaries(self) -> None:
        ...
        self.assertIn("stitch-design 0.7.4", architecture)
