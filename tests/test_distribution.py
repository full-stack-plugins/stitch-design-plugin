...
class DistributionContractTests(unittest.TestCase):
    def test_release_uses_075_across_active_surfaces(self) -> None:
        ...
        self.assertIn("compatibility distribution 0.7.5", validator.stdout)
    ...
    def test_manifest_and_readmes_remain_truthful_at_074(self) -> None:
        manifest = json.loads((ROOT / ".codex-plugin/plugin.json").read_text(encoding="utf-8"))
        self.assertEqual(manifest["version"], "0.7.5")
    ...
    def test_architecture_documents_describe_secure_harness_boundaries(self) -> None:
        ...
        self.assertIn("stitch-design 0.7.5", architecture)
