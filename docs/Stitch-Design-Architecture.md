...
>
> **Version:** 0.8.2 · **Status:** Release candidate · **Evidence date:** 2026-09-20
...
sequenceDiagram
    ...
    C->>M: resolve v0.8.2 for the release candidate
    M-->>C: stitch-design 0.8.2 candidate
...
**Document version:** 2.7.10 · **Status:** Aligned with the 0.8.2 release candidate · **Updated:** 2026-09-20
