...
>
> **Version:** 0.7.5 · **Status:** Release candidate · **Evidence date:** 2026-09-14
...
sequenceDiagram
    ...
    C->>M: resolve main for 0.7.5 candidate
    M-->>C: stitch-design 0.7.5 candidate
...
**Document version:** 2.7.5 · **Status:** Aligned with the 0.7.5 release candidate · **Updated:** 2026-09-14
