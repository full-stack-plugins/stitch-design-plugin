...
>
> **Version:** 0.8.6 · **Status:** Release candidate · **Evidence date:** 2026-09-20
...
sequenceDiagram
    ...
    C->>M: resolve v0.8.6 for the release candidate
    M-->>C: stitch-design 0.8.6 candidate
...
| Offline suite | 388 tests, no external network | The suite must run in the same environment that runs the plugin |
...
**Document version:** 2.7.10 · **Status:** Aligned with the 0.8.6 release candidate · **Updated:** 2026-09-20
