...
> **Scope:** Implementation decisions, interfaces, security controls, tests, release, and migration for Stitch Design 0.7.5.
>
> **Updated:** 2026-09-14
...
**Document version:** 2.7.5 · **Status:** Aligned with the 0.7.5 release candidate
