...
[![Version](https://img.shields.io/badge/release-0.8.3-1A73E8)](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.3)
[![Tests](https://img.shields.io/badge/tests-350%20passing-18a957)](#development-and-verification)
...
```bash
codex plugin marketplace add full-stack-plugins/stitch-design-plugin --ref v0.8.3
...
GitHub shorthand pinned by the repository-local marketplace to `v0.8.3`:
...
Full Git URL pinned to immutable `v0.8.3`:

```bash
codex plugin marketplace add https://github.com/full-stack-plugins/stitch-design-plugin.git --ref v0.8.3
codex plugin add stitch-design@partme-ai-stitch
```
...
| Current candidate | `0.8.3` |
| Current release | [v0.8.3](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.3) |
| Previous release | [v0.8.2](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.2) |
