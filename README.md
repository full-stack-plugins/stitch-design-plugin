...
[![Version](https://img.shields.io/badge/release-0.8.2-1A73E8)](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.2)
...
```bash
codex plugin marketplace add full-stack-plugins/stitch-design-plugin --ref v0.8.2
...
GitHub shorthand pinned by the repository-local marketplace to `v0.8.2`:
...
Full Git URL pinned to immutable `v0.8.2`:

```bash
codex plugin marketplace add https://github.com/full-stack-plugins/stitch-design-plugin.git --ref v0.8.2
codex plugin add stitch-design@partme-ai-stitch
```
...
| Current candidate | `0.8.2` |
| Current release | [v0.8.2](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.2) |
| Previous release | [v0.8.1](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.1) |
