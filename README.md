...
[![Version](https://img.shields.io/badge/release-0.8.1-1A73E8)](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.1)
...
```bash
codex plugin marketplace add full-stack-plugins/stitch-design-plugin --ref v0.8.1
...
GitHub shorthand pinned by the repository-local marketplace to `v0.8.1`:
...
Full Git URL pinned to immutable `v0.8.1`:

```bash
codex plugin marketplace add https://github.com/full-stack-plugins/stitch-design-plugin.git --ref v0.8.1
codex plugin add stitch-design@partme-ai-stitch
```
...
| Current candidate | `0.8.1` |
| Current release | [v0.8.1](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.1) |
| Previous release | [v0.8.0](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.0) |
