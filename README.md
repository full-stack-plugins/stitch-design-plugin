...
GitHub shorthand pinned by the repository-local marketplace to `v0.8.6`:
...
Full Git URL pinned to immutable `v0.8.6`:
...
| Current candidate | `0.8.6` |
| Current release | [v0.8.6](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.6) |
| Previous release | [v0.8.5](https://github.com/full-stack-plugins/stitch-design-plugin/releases/tag/v0.8.5) |
