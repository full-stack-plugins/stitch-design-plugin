...
Stitch Design does not collect, store, sell, or independently transmit user data. It packages local Agent Skills and configures a connection from the user's supported coding-agent host to Google Stitch.
