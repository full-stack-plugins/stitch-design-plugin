# AGENTS.md — Google Stitch Design
...
```bash
node scripts/bump-plugin.mjs stitch-design patch   # 文档/注释/小修复
node scripts/bump-plugin.mjs stitch-design minor   # 新功能
node scripts/bump-plugin.mjs stitch-design major   # 破坏性变更
```
...
cd <市场仓目录>  # 本仓: workspace-agent-skills/full-stack-plugins
python3 - <<'EOF'
import json
